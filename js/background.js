...
function getWebGLContext(e) {
	var r, t, n = {alpha: !0, depth: !1, stencil: !1, antialias: !1, preserveDrawingBuffer: !1},
		i = e.getContext("webgl2", n), a = !!i;
	...
	return u = a ? (o = getSupportedFormat(i, i.RGBA16F, i.RGBA, c), l = getSupportedFormat(i, i.RG16F, i.RG, c), getSupportedFormat(i, i.R16F, i.RED, c)) : (o = getSupportedFormat(i, i.RGBA, i.RGBA, c), l = getSupportedFormat(i, i.RGBA, i.RGBA, c), getSupportedFormat(i, i.RGBA, i.RGBA, c)), {
		gl: i,
		ext: {formatRGBA: o, formatRG: l, formatR: u, halfFloatTexType: c, supportLinearFiltering: t}
	}
}
...
var dye, velocity, divergence, curl, pressure, bloom, sunrays, sunraysTemp,
	...
	}), bloomFramebuffers = [], ditheringTexture = createTextureAsync("assets/background.png"),
	blurProgram = new Program(blurVertexShader, blurShader), copyProgram = new Program(baseVertexShader, copyShader),
	clearProgram = new Program(baseVertexShader, clearShader), colorProgram = new Program(baseVertexShader, colorShader),
...
function initFramebuffers() {
	var e = getResolution(config.SIM_RESOLUTION), r = getResolution(config.DYE_RESOLUTION), t = ext.halfFloatTexType,
		n = ext.formatRGBA, i = ext.formatRG, a = ext.formatR, o = ext.supportLinearFiltering ? gl.LINEAR : gl.NEAREST;
...
function initBloomFramebuffers() {
	var e = getResolution(config.BLOOM_RESOLUTION), r = ext.halfFloatTexType, t = ext.formatRGBA,
	...
	for (var i = bloomFramebuffers.length = 0; i < config.BLOOM_ITERATIONS; i++) {
		var a = e.width >> i + 1, o = e.height >> i + 1;
		if (a < 2 || o < 2) break;
...
function initSunraysFramebuffers() {
	var e = getResolution(config.SUNRAYS_RESOLUTION), r = ext.halfFloatTexType, t = ext.formatR,
		n = ext.supportLinearFiltering ? gl.LINEAR : gl.NEAREST;
...
function createDoubleFBO(e, r, t, n, i, a) {
	var o = createFBO(e, r, t, n, i, a), l = createFBO(e, r, t, n, i, a);
	return {
		width: e, height: r, texelSizeX: o.texelSizeX, texelSizeY: o.texelSizeY, get read() {
			return o
		}, set read(e) {
			o = e
		}, get write() {
...
function createTextureAsync(e) {
	...
	var t = {
		texture: r, width: 1, height: 1, attach: function (e) {
...
var lastUpdateTime = Date.now(), colorUpdateTimer = 0, changeColor = function () {
...
function calcDeltaTime() {
	var e = Date.now(), r = (e - lastUpdateTime) / 1e3;
	return r = Math.min(r, .016666), lastUpdateTime = e, r
}

function resizeCanvas() {
	var e = scaleByPixelRatio(canvas.clientWidth), r = scaleByPixelRatio(canvas.clientHeight);
...
function render(e) {
	...
	var r = null == e ? gl.drawingBufferWidth : e.width, t = null == e ? gl.drawingBufferHeight : e.height;
	gl.viewport(0, 0, r, t);
...
function applyBloom(e, r) {
	if (!(bloomFramebuffers.length < 2)) {
		...
		var n = config.BLOOM_THRESHOLD * config.BLOOM_SOFT_KNEE + 1e-4, i = config.BLOOM_THRESHOLD - n, a = 2 * n,
			o = .25 / n;
...
function splatPointer(e) {
	var r = e.deltaX * config.SPLAT_FORCE, t = e.deltaY * config.SPLAT_FORCE;
...
function getResolution(e) {
	...
	return gl.drawingBufferWidth > gl.drawingBufferHeight ? {width: n, height: t} : {width: t, height: n}
}
...
window.addEventListener("touchend", function (e) {
	...
	if (!switchPage || !switchPage.switched) {
		var r = scaleByPixelRatio(e.pageX), t = scaleByPixelRatio(e.pageY), n = pointers.find(function (e) {
			return -1 == e.id
		});
	...
	if (!switchPage || !switchPage.switched) {
		...
		for (var t = 0; t < r.length; t++) {
			var n = scaleByPixelRatio(r[t].pageX), i = scaleByPixelRatio(r[t].pageY);
